...
`nemeton::read_fast_alert_raster()` qui consommera le wiring final n’est
pas encore livrée — ce cycle dev ne touche que les libellés i18n et
l’en-tête du popup Leaflet pour éviter une dette i18n quand le raster
arrivera.
...
- `monitoring_fast_alert_popup_severity` conservé « Sévérité » / «
  ...
  discrètes quand `nemeton::read_fast_alert_raster()` aura tranché.
