...
#
# Même cadre / police / picto (engrenage qui tourne) / chronomètre qui defile
...
# Contenu unifié d'une notif « en cours » : picto engrenage qui tourne (classe
# CSS `nmt-spin`) + libellé + (si `start` fourni) chronomètre monospace
# « — MM:SS » qui défile. `label` peut être un texte ou des tags htmltools.
# Rendu identique partout (cadre / police / picto) — moteur de calcul monitoring
# FAST/FORDEAD/RECONFORT et moteur reGénération.
