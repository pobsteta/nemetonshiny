...
TRANSLATIONS <- list(
  ...
  acc_buffer = list(fr = "Zone tampon autour de la for\u00eat (km)", en = "Buffer around the forest (km)"),
  ...
  acc_compare_legend_origine = list(fr = "BD TOPO (origine)", en = "BD TOPO (original)"),
  acc_compare_legend_corrigee = list(fr = "Largeur carrossable (corrig\u00e9e)", en = "Drivable width (corrected)"),
