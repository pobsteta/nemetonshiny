...
TRANSLATIONS <- list(
  ...
  acc_ndp1_lidar_label = list(fr = "NDP 1 : corriger la desserte au LiDAR (largeur mesur\u00e9e)", en = "NDP 1: correct the road network with LiDAR (measured width)"),
  ...
  acc_ndp1_duration_note = list(fr = "Calcul long (~2-3 h sur une desserte r\u00e9elle) : la largeur carrossable est mesur\u00e9e tron\u00e7on par tron\u00e7on, ce qui rend les d\u00e9parts c\u00e2ble s\u00e9lectifs. Fiable (repli automatique sur la desserte brute si la qualification \u00e9choue).", en = "Long computation (~2-3 h on a real road network): trafficable width is measured segment by segment, making cable landings selective. Reliable (automatic fallback to the raw network if qualification fails)."),
  ...
  accessfor_swipe_toggle = list(fr = "Comparer au volet (classes de d\u00e9bardage \u2194 ACCESSFOR)", en = "Swipe compare (skidding classes \u2194 ACCESSFOR)"),
  ...
  accessfor_swipe_missing = list(fr = "Comparaison impossible : il manque la couche classes de d\u00e9bardage ou ACCESSFOR.", en = "Cannot compare: the skidding-classes or ACCESSFOR layer is missing."),
