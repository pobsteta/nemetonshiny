...
TRANSLATIONS <- list(
  ...
  ug_line_split_select_one = list(fr = "Pour d\u00e9couper avec une ligne, s\u00e9lectionnez d'abord un seul t\u00e8nement sur la carte (clic), puis dessinez la ligne.", en = "To split with a line, first select exactly one tenement on the map (click), then draw the line."),
  ug_line_split_title = list(fr = "D\u00e9couper le t\u00e8nement avec la ligne", en = "Split tenement with the drawn line"),
  ug_line_split_desc = list(fr = "Couper le t\u00e8nement \u00ab %s \u00bb le long de la ligne dessin\u00e9e.", en = "Cut tenement '%s' along the drawn line."),
  ug_line_split_success = list(fr = "T\u00e8nement d\u00e9coup\u00e9 avec succ\u00e8s", en = "Tenement successfully split"),
