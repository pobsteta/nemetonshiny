...
create_couchey_mini_fixture <- function() {
  ...
  indicators$indicateur_l2_morcellement  <- c(75.2, 69.8, 80.5)
  indicators$indicateur_l1_effet_lisiere <- c(60.4, 55.1, 65.7)
  ...
  indicators$famille_paysage      <- rowMeans(indicators[, c("indicateur_l2_morcellement", "indicateur_l1_effet_lisiere")])
