...
Loads and exposes the configurable profiles used to classify UGF (Unites
de Gestion Forestiere). The profile selected for a project determines: -
the dropdown label (e.g. "Groupe d'amenagement" for ONF, "Groupe de
