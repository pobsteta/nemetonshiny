...
1.  Déterminer le type de changement selon Conventional Commits (feat: /
    ...
    / major). **Ne PAS sous-bumper** : appliquer strictement la table
    ci-dessous (révision 2026-06-02 suite au constat que l’app stagnait
    sur 0.52.x pendant que le cœur avançait sur 0.55 → 0.60).
    ...
    plusieurs feat en une seule release : ne pas attendre — chaque feat
    fonctionnel mérite son MINOR.
